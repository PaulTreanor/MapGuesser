...
export default function TopBarGame({ roundLocation, score, currentRound, roundCompleted, moveToNextRound}) {
  return (
    <nav className="border-gray-200 pointer-events-none min-h-64">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 pointer-events-auto">
        <div className="flex items-center">
          <h1 className="text-amber-700 text-3xl font-bold z-30 mr-4">MapGuesser</h1>
        ...
        <div className='px-4 py-2 bg-white rounded-md z-30'>
