/** 
 * Colours are simple in the project because I'm leaning on TailwindCSS defaults.
 * These aren't really available outside of CSS but are needed in JS for certain animations etc, so keeping them here. 
